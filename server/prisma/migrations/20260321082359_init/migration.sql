...
-- CreateEnum
CREATE TYPE "AccessRule" AS ENUM ('OPEN', 'ON_INVITATION', 'ON_PAYMENT');

-- CreateEnum
CREATE TYPE "LessonType" AS ENUM ('VIDEO', 'DOCUMENT', 'IMAGE', 'QUIZ');

-- CreateEnum
CREATE TYPE "EnrollStatus" AS ENUM ('YET_TO_START', 'IN_PROGRESS', 'COMPLETED');
...
CREATE TABLE "Course" (
    ...
    "accessRule" "AccessRule" NOT NULL DEFAULT 'OPEN',
...
CREATE TABLE "QuizReward" (
    "id" TEXT NOT NULL,
    "quizId" TEXT NOT NULL,
    "attempt1" INTEGER NOT NULL DEFAULT 100,
    "attempt2" INTEGER NOT NULL DEFAULT 75,
    "attempt3" INTEGER NOT NULL DEFAULT 50,
    "attempt4" INTEGER NOT NULL DEFAULT 25,
...
CREATE TABLE "Enrollment" (
    ...
    "status" "EnrollStatus" NOT NULL DEFAULT 'YET_TO_START',
...
-- CreateIndex
CREATE UNIQUE INDEX "QuizReward_quizId_key" ON "QuizReward"("quizId");
