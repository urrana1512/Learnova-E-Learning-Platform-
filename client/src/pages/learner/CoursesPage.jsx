...
const CourseCard = ({ course, enrollment, onEnroll }) => {
  ...
  const getButtonState = () => {
    ...
    if (course.accessRule === "ON_PAYMENT" && !enrollment)
      return {
        label: `Premium · ₹${course.price}`,
        icon: <Lock size={14} />,
        action: () => navigate(`/learner/courses/${course.id}`),
      };
    if (!enrollment)
      return {
        label: "Start Learning",
        icon: <ArrowRight size={14} />,
        action: () => onEnroll(course.id),
      };
    ...
    >
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <p className="text-xs text-slate-500 font-medium leading-relaxed mb-4 line-clamp-2 flex-1">
          {course.description ||
            "Master professional skills with expert-led curriculum and hands-on projects."}
        </p>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
              ...
              <div className="flex-1 max-w-2xl text-center lg:text-left">
                ...
                >
                  <Sparkles
                    size={14}
                    className="text-[#017E84] animate-pulse"
                  />
                ...
                >
                  Empowering learners with interactive courses, expert guidance,
                  and real-world skills to succeed in the digital era.
                </motion.p>
                ...
                >
                  {stats.map((s, i) => (
                    <div
                      key={i}
                      className="flex flex-col items-center lg:items-start gap-1 p-3 rounded-2xl hover:bg-slate-50 transition-colors border border-transparent hover:border-slate-100 cursor-default"
                    >
                      <span className="text-4xl font-black text-slate-900 font-sora tracking-tighter drop-shadow-sm">
                        {s.value}
                        <span className="text-[#017E84]">+</span>
                      </span>
                ...
                <div className="relative w-[400px] h-[480px] transition-transform duration-700 ease-out hover:-translate-y-2">
                  ...
                  <div className="absolute inset-0 bg-white/70 border-2 border-slate-100/50 rounded-[3rem] shadow-2xl overflow-hidden backdrop-blur-xl flex flex-col p-8 opacity-100">
                    <div className="flex justify-between items-center mb-8">
                      ...
                      <span className="bg-[#017E84]/10 text-[#017E84] px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-[0.2em]">
                        Active Port
                      </span>
                    </div>

                    <h3 className="text-xl font-black text-slate-900 font-sora tracking-tight mb-2">
                      Initialize Sequence
                    </h3>
                    <p className="text-[11px] font-bold text-slate-500 uppercase tracking-widest leading-relaxed mb-8">
                      System metrics synchronized
                    </p>
                    ...
                    <div className="space-y-4 mt-auto border-t border-slate-100 pt-6">
                      {[
                        ...
                        <div key={i} className="flex items-center gap-4">
                          <div
                            className={`w-8 h-8 rounded-xl ${style.bg}/10 flex items-center justify-center`}
                          >
                  ...
                  <div className="absolute -right-6 top-58 bg-white border border-slate-100 px-5 py-4 rounded-3xl shadow-xl flex items-center gap-4 backdrop-blur-md animate-float z-30 group-hover:border-[#017E84]/30 transition-colors">
                    ...
                    <div>
                      ...
                      <p className="text-[9px] text-amber-500 font-black uppercase tracking-[0.2em]">
                        Verified Node
                      </p>
                    </div>
                  </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-10">
            ...
            <div className="flex items-center gap-2 text-sm text-slate-500 font-bold">
              ...
              <span className="text-[#714B67] font-black">
                {filtered.length}
              </span>{" "}
              courses found
            </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-32 border-2 border-dashed border-slate-200 rounded-3xl">
              ...
              <h3 className="text-xl font-black text-slate-400 font-sora">
                No courses found
              </h3>
